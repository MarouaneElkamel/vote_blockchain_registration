...
export class VoteService {
    ...
    private convertItemFromServer(vote: Vote): Vote {
        ...
        copy.inscriptionDate = this.dateUtils
            .convertDateTimeFromServer(vote.inscriptionDate);
        copy.inscriptionEndDate = this.dateUtils
            .convertDateTimeFromServer(vote.inscriptionEndDate);
        copy.voteDate = this.dateUtils
            .convertDateTimeFromServer(vote.voteDate);
        copy.voteEndDate = this.dateUtils
            .convertDateTimeFromServer(vote.voteEndDate);
        copy.resultDate = this.dateUtils
            .convertDateTimeFromServer(vote.resultDate);
        return copy;
    }
    ...
    private convert(vote: Vote): Vote {
        ...
        copy.inscriptionDate = this.dateUtils.toDate(vote.inscriptionDate);

        copy.inscriptionEndDate = this.dateUtils.toDate(vote.inscriptionEndDate);

        copy.voteDate = this.dateUtils.toDate(vote.voteDate);

        copy.voteEndDate = this.dateUtils.toDate(vote.voteEndDate);

        copy.resultDate = this.dateUtils.toDate(vote.resultDate);
        return copy;
    }
}
